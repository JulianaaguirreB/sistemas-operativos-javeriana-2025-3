...
// Conclusiones:
// Este programa permitió entender cómo trabajar con directorios.
// Se aprendió a abrir y leer carpetas, y a obtener información de los archivos.
// También se practicó cómo usar los permisos, las fechas y los tipos de archivo.
// Es útil para ver cómo el sistema operativo guarda y maneja los archivos.
// En general, ayuda a comprender mejor cómo funciona el manejo de ficheros.
