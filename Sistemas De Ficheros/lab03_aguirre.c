...
* Profesor: J. Corredor
* Descripción:
* Este programa permite leer un directorio ingresado por el usuario
* y mostrar información detallada de cada archivo dentro de él.
* Entre los datos que presenta se incluyen:
*   - Si el archivo tiene permiso de lectura para el propietario.
*   - Si es un archivo regular o un directorio.
*   - Los archivos modificados en los ultimos 10 dias,
*     junto con la fecha de su última modificacion.
*********************************************************/
