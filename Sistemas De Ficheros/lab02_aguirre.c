...
// Conclusiones:
// Este programa ayudó a practicar cómo abrir y leer directorios.
// Se aprendió a usar la función stat() para obtener información de los archivos.
// También se vio cómo manejar errores cuando el directorio no existe.
// Permite entender mejor cómo el sistema guarda los tamaños y tipos de archivo.
// Es útil para conocer el funcionamiento básico de los ficheros en sistemas operativos.
